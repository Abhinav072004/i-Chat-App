...
className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
           ...
           <span className='text-blue-500'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Link to='/login' className='text-sm hover:underline hover:text-blue--600 mt-4 inline-block' href='#'>Already have an account?
                </Link> 
            <div>

                <button className=" btn btn-block btn-sm mt-2 border-green-700" disabled={loading}> 
